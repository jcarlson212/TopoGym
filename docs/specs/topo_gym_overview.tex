...
\paragraph{Canonical environments.} Six named environments form the
...
Scenario sizes are fixed (IceShip/Ladders/BankRobber/SpaceWarp: 50;
DontFall: 61; ClownChase: 60); layouts vary with the seed under each
