...
python scripts/browse.py --all --split test -n 4 --chunk 8
\end{lstlisting}

\noindent Figures~\ref{fig:test-split-1}--\ref{fig:test-split-9}
are that command's output for the hold-out split: every family at
four test seeds, which is what the splits actually look like.

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-1.png}
  \caption{The hold-out (\textbf{test}) split, part 1 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-1}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-2.png}
  \caption{The hold-out (\textbf{test}) split, part 2 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-2}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-3.png}
  \caption{The hold-out (\textbf{test}) split, part 3 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-3}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-4.png}
  \caption{The hold-out (\textbf{test}) split, part 4 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-4}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-5.png}
  \caption{The hold-out (\textbf{test}) split, part 5 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-5}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-6.png}
  \caption{The hold-out (\textbf{test}) split, part 6 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-6}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-7.png}
  \caption{The hold-out (\textbf{test}) split, part 7 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-7}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-8.png}
  \caption{The hold-out (\textbf{test}) split, part 8 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-8}
\end{figure}

\begin{figure}[p]
  \centering
  \includegraphics[width=\linewidth]{../splits/test-split-9.png}
  \caption{The hold-out (\textbf{test}) split, part 9 of 9: four instances of each family at seeds 4000--4003 with size-scaled placement jitter. Each panel is labelled with its seed, turn-aware optimal $d^{\star}$, and horizon. Instances differ while the family's arrangement holds --- and the $d^{\star}$ values along a row show the difficulty distribution the split is drawn from.}
  \label{fig:test-split-9}
\end{figure}
