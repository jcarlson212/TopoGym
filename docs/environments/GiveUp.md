...
<img src="../envs/GiveUp1-50.png" width="360"/>

The chamber's door hides behind a dead-end corridor of the given length; longer corridors punish giving up early.
...
| id | certified b(Z/2) |
|---|---|
| `TopoGym/GiveUp1-50-v0` | `[1, 1, 0]` |
| `TopoGym/GiveUp2-50-v0` | `[1, 1, 0]` |
| `TopoGym/GiveUp4-50-v0` | `[1, 1, 0]` |
