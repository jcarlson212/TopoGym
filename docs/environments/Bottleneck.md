...
<img src="../envs/Bottleneck6-100.gif" width="360"/>

A tree of rooms joined by width-1 corridors: zero homology signal, pure bottleneck difficulty.
...
| id | certified b(Z/2) |
|---|---|
| `TopoGym/Bottleneck3-100-v0` | `[1, 0, 0]` |
| `TopoGym/Bottleneck6-100-v0` | `[1, 0, 0]` |
