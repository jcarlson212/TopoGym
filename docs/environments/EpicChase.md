...
<img src="../envs/EpicChase4-90.png" width="360"/>
...
> **In no benchmark.** Chambers sit a full episode apart along one spiral corridor, so no single episode can reach the goal. It grades archive-based methods rather than policies, and scores incomparably to the graded families -- a stress test, kept out of every roster on purpose.
