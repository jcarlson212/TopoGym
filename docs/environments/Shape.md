...
<img src="../envs/ShapeSt-50.gif" width="360"/>

Area-matched chamber shapes (square, circle, triangle, star): shape is never confounded with size.
...
| id | certified b(Z/2) |
|---|---|
| `TopoGym/ShapeSq-50-v0` | `[1, 1, 0]` |
| `TopoGym/ShapeCi-50-v0` | `[1, 1, 0]` |
| `TopoGym/ShapeTr-50-v0` | `[1, 1, 0]` |
| `TopoGym/ShapeSt-50-v0` | `[1, 1, 0]` |
