...
<img src="../envs/Maze-50.gif" width="360"/>

A seeded perfect maze (simply connected); the braid knob opens loops, each adding one H1 class.
...
| id | certified b(Z/2) |
|---|---|
| `TopoGym/Maze-50-v0` | `[1, 0, 0]` |
| `TopoGym/Maze-100-v0` | `[1, 0, 0]` |
