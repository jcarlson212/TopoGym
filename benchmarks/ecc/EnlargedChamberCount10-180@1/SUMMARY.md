...
|---|---:|---:|---:|---:|
| `go-explore-phase1` | 2067 | 6.43% | 0 | 0 |

A **†** marks a method that adapts within the layout rather than transferring a fixed policy.

## How this was run

- **environment**: `TopoGym/EnlargedChamberCount10-180-v0` at **layout seed 1**
- **algorithm seed**: 0
- **budget**: 1,000,000 environment steps of training, 16666 episodes
- **evaluation**: 100 episodes at a horizon of 490 (without archive resets)
