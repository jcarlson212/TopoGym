...
|---|---:|---:|---:|---:|
| `go-explore-phase1` | 194 | 2.21% | 0 | 0 |

A **†** marks a method that adapts within the layout rather than transferring a fixed policy.

## How this was run

- **environment**: `TopoGym/EpicChase12-150-v0` at **layout seed 5**
- **algorithm seed**: 0
- **budget**: 1,000,000 environment steps of training, 5555 episodes
- **evaluation**: 100 episodes at a horizon of 2080 (without archive resets)
