...
|---|---:|---:|---:|---:|
| `go-explore-phase1` | 324 | 3.69% | 0 | 0 |

A **†** marks a method that adapts within the layout rather than transferring a fixed policy.

## How this was run

- **environment**: `TopoGym/EpicChase12-150-v0` at **layout seed 22**
- **algorithm seed**: 0
- **budget**: 1,000,000 environment steps of training, 5555 episodes
- **evaluation**: 100 episodes at a horizon of 4440 (without archive resets)
