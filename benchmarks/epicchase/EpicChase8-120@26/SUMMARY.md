...
|---|---:|---:|---:|---:|
| `go-explore-phase1` | 272 | 4.97% | 0 | 0 |

A **†** marks a method that adapts within the layout rather than transferring a fixed policy.

## How this was run

- **environment**: `TopoGym/EpicChase8-120-v0` at **layout seed 26**
- **algorithm seed**: 0
- **budget**: 1,000,000 environment steps of training, 5555 episodes
- **evaluation**: 100 episodes at a horizon of 2830 (without archive resets)
