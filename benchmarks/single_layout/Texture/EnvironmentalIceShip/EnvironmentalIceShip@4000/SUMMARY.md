...
|---|---:|---:|---:|---:|
| `icm-ppo` | 756 | 60.43% | 0 | 0 |
| `rnd-ppo` | 650 | 51.96% | 0 | 0 |
| `ppo` | 376 | 30.06% | 0 | 0 |
| `go-explore-phase1` | 375 | 29.98% | 0 | 0 |
| `random` | 375 | 29.98% | 0 | 0 |

A **†** marks a method that adapts within the layout rather than transferring a fixed policy.

## How this was run

- **environment**: `TopoGym/EnvironmentalIceShip-v0` at **layout seed 4000**
- **algorithm seed**: 0
