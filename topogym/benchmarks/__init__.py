...
_RAW = {
    ...
    "2d_bench_grid_small_bridges": [
        ("square-dumbbell", 501,
         "two rooms, one narrow passage: b1 = 0, all bottleneck",
         _c2(base="square", size=17, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(1, 1),
             partition_hidden_gaps=(0, 0))),
        ("square-twin-passages", 502,
         "two passages through one wall: the loop closure env",
         _c2(base="square", size=17, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(0, 0))),
        ("square-moat-hidden", 503,
         "a moat you can see across; one open bridge, one hidden",
         _c2(base="square", size=19, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(1, 1), partition_material="moat",
             door_tries=(2, 4))),
        ("square-triple-rooms", 504, "two dividing walls, three regions",
         _c2(base="square", size=21, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=2, partition_gaps=(1, 2),
             partition_hidden_gaps=(0, 1))),
        ("cylinder-ring-gate", 505, "a gate across the cylinder",
         _c2(base="cylinder", size=17, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(1, 1),
             partition_hidden_gaps=(0, 0))),
        ("torus-meridian", 506,
         "a meridian wall on the torus: close the loop through the wrap",
         _c2(base="torus", size=17, n_holes=1, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(1, 1),
             partition_hidden_gaps=(0, 0))),
        ("sphere-belt", 507, "an equatorial belt with two passages",
         _c2(base="sphere", size=7, n_holes=0, n_chambers=0, n_decoys=0,
             n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(0, 0))),
        ("square-bridge-gauntlet", 508,
         "a moat with a hidden bridge, plus a chamber and a decoy",
         _c2(base="square", size=21, n_holes=0, n_chambers=1, n_decoys=1,
             n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(1, 1), partition_material="moat")),
    ],
    "3d_bench_grid_small_bridges": [
        ("box-dumbbell", 601, "two chambers of space, one tunnel",
         _c3(base="box", size=11, n_rings=0, n_blobs=0, n_chambers=0,
             n_decoys=0, n_partitions=1, partition_gaps=(1, 1),
             partition_hidden_gaps=(0, 0))),
        ("box-two-tunnels", 602, "two tunnels through one wall: b1 = 1",
         _c3(base="box", size=11, n_rings=0, n_blobs=0, n_chambers=0,
             n_decoys=0, n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(0, 0))),
        ("box-hidden-tunnel", 603, "one tunnel open, one hidden",
         _c3(base="box", size=11, n_rings=0, n_blobs=0, n_chambers=0,
             n_decoys=0, n_partitions=1, partition_gaps=(2, 2),
             partition_hidden_gaps=(1, 1), door_tries=(2, 4))),
        ("solid-torus-gate", 604,
         "a gate disc across the solid torus: the wrap loop passes it",
         _c3(base="solid_torus", size=11, n_rings=0, n_blobs=1,
...
_COLLECTION_ID = {
    ...
    "2d_bench_grid_small_bridges": "Bench2DSmallBridges",
    "3d_bench_grid_small": "Bench3DSmall",
    "3d_bench_grid_small_directed": "Bench3DSmallDirected",
    "3d_bench_grid_small_bridges": "Bench3DSmallBridges",
}
